      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-20 text-center md:text-left">
          ...
          <p className="text-gray-500 font-mono text-sm uppercase tracking-widest">
            Chronological career &amp; academic evolution
          </p>
        </div>
                  ...
                  <div className="glass overflow-hidden rounded-3xl hover:border-amber-400/20 transition-all duration-500 group reveal">
                    <div className="p-8">
                      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                        <div>
                          <span className="text-amber-400 font-mono text-[10px] font-bold tracking-widest block mb-1">
                            {exp.period}
                          </span>
                      ...
                      <ul className="space-y-3 mb-8">
                        {exp.description.map((item, i) => (
                          <li
                            key={i}
                            className="text-gray-500 text-sm leading-relaxed flex items-start gap-3"
                          >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.skills.map((skill) => (
                          <span
                            key={skill}
                            className="px-3 py-1 bg-amber-400/5 rounded-full text-[10px] font-mono text-amber-300/60 border border-amber-400/10"
                          >
                            {skill}
                          </span>
                        ))}
