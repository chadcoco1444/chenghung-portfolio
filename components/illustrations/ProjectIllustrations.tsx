...
export const ProjectIllustration: React.FC<{ id: number }> = ({ id }) => {
  switch (id) {
      ...
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(200, 90)">
            <path
              d="M 0 -35 C -20 -35 -28 -18 -28 -8 C -28 12 0 35 0 35 C 0 35 28 12 28 -8 C 28 -18 20 -35 0 -35 Z"
              fill="#3b82f6"
              opacity="0.3"
              stroke="#60a5fa"
              strokeWidth="1.5"
          ...
          />
          {/* Coordinates */}
          <text x="30" y="185" fill="#10b981" fontSize="10" opacity="0.3" fontFamily="monospace">
    ...
    case 3: // Modem Footprint Optimization
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Arrow */}
          <path
            d="M 220 90 L 260 90 L 255 82 M 260 90 L 255 98"
            fill="none"
            stroke="#60a5fa"
            strokeWidth="2"
            opacity="0.5"
    ...
    case 4: // Unit Testing & Automation
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Test output lines */}
          <text x="80" y="72" fill="#10b981" fontSize="11" opacity="0.7" fontFamily="monospace">
            PASS test_rrc_handler
          </text>
          <text x="80" y="90" fill="#10b981" fontSize="11" opacity="0.7" fontFamily="monospace">
            PASS test_nas_decode
          </text>
          <text x="80" y="108" fill="#10b981" fontSize="11" opacity="0.7" fontFamily="monospace">
            PASS test_cell_select
          </text>
          <text x="80" y="126" fill="#10b981" fontSize="11" opacity="0.7" fontFamily="monospace">
            PASS test_lpp_cp_up
          </text>
          <text x="80" y="152" fill="#8b5cf6" fontSize="11" opacity="0.6" fontFamily="monospace">
    ...
    case 5: // Wireless Charger 15W
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Lightning bolt */}
          <path
            d="M 197 95 L 205 95 L 200 108 L 208 108 L 195 128 L 200 112 L 193 112 Z"
            fill="#eab308"
            opacity="0.5"
          />
          {/* 15W label */}
      ...
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <g opacity="0.3">
            ...
            <text x="50" y="90" fill="#ec4899" fontSize="8" fontFamily="monospace">
              PACKETS
            </text>
            <text x="290" y="72" fill="#10b981" fontSize="7" fontFamily="monospace">
              SAFE
            </text>
            <text x="290" y="135" fill="#ef4444" fontSize="7" fontFamily="monospace">
              ALERT
            </text>
          </g>
        </svg>
    ...
    case 7: // Head Unit Display
      return (
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* RPM gauge */}
          <path
            d="M 260 110 A 35 35 0 0 1 225 75"
            fill="none"
            stroke="#06b6d4"
            strokeWidth="3"
            opacity="0.2"
          ...
          />
          <path
            d="M 260 110 A 35 35 0 0 1 245 78"
            fill="none"
            stroke="#06b6d4"
            strokeWidth="3"
            opacity="0.4"
          ...
          <g opacity="0.2">
            ...
            <text x="90" y="192" fill="#06b6d4" fontSize="8" fontFamily="monospace">
              CAN
            </text>
            <text x="290" y="192" fill="#06b6d4" fontSize="8" fontFamily="monospace">
              SPI
            </text>
          </g>
        </svg>
        ...
        <svg viewBox="0 0 400 200" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(70, 50)">
            <circle
              ...
              strokeOpacity="0.3"
            />
            <text x="0" y="-3" textAnchor="middle" fill="#ef4444" fontSize="14" opacity="0.5">
              T
            </text>
            <text
              x="0"
          ...
          <g transform="translate(70, 140)">
            <circle
              ...
              strokeOpacity="0.3"
            />
            <text x="0" y="-3" textAnchor="middle" fill="#3b82f6" fontSize="14" opacity="0.5">
              H
            </text>
            <text
              x="0"
          ...
          <g transform="translate(330, 50)">
            ...
            />
            <path
              d="M -4 -8 L 2 -8 L -1 -1 L 5 -1 L -3 10 L 0 2 L -5 2 Z"
              fill="#eab308"
              opacity="0.5"
            />
            <text
          ...
          {/* Chart at bottom */}
          <polyline
            points="100,180 140,175 180,178 220,168 260,172 300,165"
            fill="none"
            stroke="#10b981"
            strokeWidth="1.5"
            opacity="0.3"
