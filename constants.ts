...
export const OPEN_SOURCE_PROJECTS: OpenSourceProject[] = [
  {
    ...
    techStack: ['Next.js 14', 'Fastify', 'TypeScript', 'BullMQ', 'Redis', 'Playwright', 'Remotion 4', 'Claude Sonnet', 'NextAuth v5', 'PostgreSQL', 'S3 / MinIO'],
  ...
  },
  {
    ...
    description: 'A VSCode extension that visualizes Claude Code task progress, subagent convergence, and session lifecycle — across one or many windows, grouped by repo and git worktree. Claude Code hooks append events to a JSONL stream; the extension watches the file, reduces events into state, and renders a live tree (repo ▸ worktree ▸ feature ▸ task / subagent), a dashboard webview, and a status-bar summary.',
    techStack: ['TypeScript', 'VSCode Extension API', 'esbuild', 'Vitest', 'Claude Code Hooks', 'JSONL'],
