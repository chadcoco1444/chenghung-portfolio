...
export const OPEN_SOURCE_PROJECTS: OpenSourceProject[] = [
  {
    ...
    highlights: [
      '38+ API endpoints · 7 Blueprint modules',
      '3 strategies with full-market real-time scanning',
      'Walk-forward backtest + Monte Carlo confidence intervals',
      'Telegram Bot with 34 commands + pre-market/closing auto alerts',
      '444 unit tests',
    ],
  },
  {
